...
const TypewriterText = () => {
    ...
    return (
        <Text
            fontSize={isMobile ? 0.04 : 0.10} // Adjust font size accordingly
            ...
            position={isMobile ? [-0.3, 0.32, 0] : [-1.1, 0.31, 0]} // Position text at the center of the texture
