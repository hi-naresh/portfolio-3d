...
const TypewriterText = () => {
    ...
    return (
        <Text
            fontSize={0.14} // Adjust font size accordingly
            color="#000" // Make the text fill color black (invisible)
            ...
            position={[-1.1, 0.32, 0]} // Position text at the center of the texture
