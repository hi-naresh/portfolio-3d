...
const Header: React.FC = React.memo(() => (
	...
	>
		<motion.div
			className="glassmorphism shadow-2xl w-[60rem] p-1.5 rounded-full flex justify-between items-center space-x-6 bg-white bg-opacity-10 "
			initial={{ width: 0 }}
			animate={{ width: "50rem" }}
		...
		>
			<motion.button
				...
				className="glassBg rounded-full p-2"
			...
			<motion.p
				className="bg-black bg-opacity-30 border-[1px] border-white/40 text-sm space-x-6 flex justify-center items-center rounded-full px-16 p-3"
				initial={{ scale: 0, opacity: 0 }}
				animate={{ scale: 1, opacity: 1 }}
